...
✅ 好的描述："简单网格布局，两列排列四个卡片，每个卡片包含图标和标题"
✅ 好的描述："居中对称布局，中间大图标，上下各一行文字"
✅ 好的描述："垂直列表布局，从上到下排列内容项目"
❌ 避免："放射状布局"、"连接线装饰"、"复杂的绝对定位"、"多层叠加效果"、"环形排列"、"中心辐射式布局"、"环绕中心"、"2x3复杂网格"

多页面布局简化原则：
- 对于8页以上的长篇内容，每页布局都应该尽可能简单
- 优先使用：垂直布局、两栏布局、简单的2x2网格
- 避免复杂的多层嵌套和精细的网格划分
- 确保每页都有充足的内容和清晰的结构
...

{
  ...
  "xiaohongshu": {
    "titles": [
      "标题1：[吸引人的标题，带相关emoji，20字以内]",
      "标题2：[另一个角度的标题，带相关emoji，20字以内]", 
      "标题3：[第三个备选标题，带相关emoji，20字以内]"
    ],
...
6. 小红书内容要求简洁有趣，符合平台调性，标题吸引点击，正文有价值且易读，标签要热门且相关（最多10个标签）
